...
public class CriarUsuarioRequestDTO {
	...
	@NotBlank(message = "Por favor, informe o nome do usuário.") // Não pode ser vazio
	private String nome;
	...
	@Pattern(regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$", message = "Por favor, informe uma senha com letras maiúsculas, mínúsculas, números, símbolos e no mínimo 8 caracteres.")
